...
namespace HSMLayoutManager.LiveSplit.LiveSplitCore
{
  /// <summary>
  ...
  public class RunRef
  {
    ...
    /// </para>
    /// <para>Game Name - Category Name</para>
    /// <para>
    ...
    /// <summary>
    /// <para>Returns a name suitable for this Run that is built the following way:</para>
    /// <para>Game Name - Category Name</para>
    /// <para>
    ...
    /// </para>
    /// <para>Any% (No Tuner, JPN, Wii Emulator)</para>
    /// </summary>
  ...
  public class RunEditorRefMut : RunEditorRef
  {
    ...
    /// active segment.
    /// </para>
    /// <para>This panics if the index of the segment provided is out of bounds.</para>
    /// </summary>
  ...
  {
    [DllImport("Libs/livesplit_core", CallingConvention = CallingConvention.Cdecl)]
